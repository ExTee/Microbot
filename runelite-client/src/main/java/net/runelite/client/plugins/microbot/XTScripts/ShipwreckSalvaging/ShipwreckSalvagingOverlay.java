...
public class ShipwreckSalvagingOverlay extends OverlayPanel {
    @Inject
    ShipwreckSalvagingOverlay(ShipwreckSalvagingPlugin plugin) {
        super(plugin);
...
//                    .text("Example Plugin V" + ShipwreckSalvagingScript.version)
//                    .color(Color.GREEN)
//                    .build());
//
