package net.runelite.client.plugins.microbot.XTScripts.theatre.prayer;
...
import net.runelite.client.plugins.microbot.XTScripts.theatre.TheatreConfig;
...
public abstract class TheatrePrayerOverlay extends Overlay
{
	...
	{
		final Widget meleePrayerWidget = client.getWidget(541, 19);
		final Widget rangePrayerWidget = client.getWidget(541, 18);
		final Widget magicPrayerWidget = client.getWidget(541, 17);
...
//	}
	...
	private void renderPrayerIconOverlay(Graphics2D graphics)
	{
		...
		{
			Prayer p = attack.getPrayer();
			Widget prayerWidget = null;
			switch (p){

				case PROTECT_FROM_MELEE : prayerWidget = client.getWidget(541, 19);
				case PROTECT_FROM_MISSILES : prayerWidget = client.getWidget(541, 18);
				case PROTECT_FROM_MAGIC : prayerWidget = client.getWidget(541, 17);
			}
