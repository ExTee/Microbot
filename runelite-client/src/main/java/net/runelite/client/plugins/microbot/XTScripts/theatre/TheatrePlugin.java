...
package net.runelite.client.plugins.microbot.XTScripts.theatre;
...
import net.runelite.client.plugins.microbot.XTScripts.theatre.Bloat.Bloat;
import net.runelite.client.plugins.microbot.XTScripts.theatre.Maiden.Maiden;
//import net.runelite.client.plugins.microbot.XTScripts.theatre.Nylocas.Nylocas;
import net.runelite.client.plugins.microbot.XTScripts.theatre.Sotetseg.Sotetseg;
import net.runelite.client.plugins.microbot.XTScripts.theatre.Verzik.Verzik;
...
//			rooms = new Room[]{maiden, bloat, nylocas, sotetseg, xarpus, verzik};
			rooms = new Room[]{maiden, bloat, sotetseg, xarpus, verzik};
